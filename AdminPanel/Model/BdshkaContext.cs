...
public partial class BdshkaContext : DbContext
{
    public BdshkaContext()
    {
    }

    public BdshkaContext(DbContextOptions<BdshkaContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=localhost;database=bdshka;user=root;password=SemmsGood11", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.39-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Post>(entity =>
        {
            ...
            entity.Property(e => e.Status)
                .HasDefaultValueSql("'просмотр'")
                .HasColumnType("enum('принято','просмотр','отклонено')")
